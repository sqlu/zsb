...
/*
 * Command Fake News
 * This command allows the selfbot user to get a random fakenews
 */

const fakenewsCommand: SlashCommand = {
  name: "fakenews",
  description: "Allows you to get a random fake news.",
  description_localizations: {
    fr: "Permet d'avoir une fake news aléatoire.",
  },
  cooldown: 20000,
...
export default fakenewsCommand;
